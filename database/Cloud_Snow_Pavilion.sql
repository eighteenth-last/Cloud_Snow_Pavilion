...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, 1, '招牌手打柠檬茶', '镇店之宝 · 每日现锤', 16.90, 16.90, 10.00, 'https://img.linlee.com/product/1.jpg', 999, 1, 1, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (2, 1, '单丛鸭屎香手打柠檬茶', '茶香浓郁 回甘悠长', 18.90, 18.90, 10.00, 'https://img.linlee.com/product/2.jpg', 999, 1, 1, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (3, 1, '五窖茉莉手打柠檬茶', '茉莉清香 清爽解腻', 18.90, 18.90, 10.00, 'https://img.linlee.com/product/3.jpg', 999, 1, 1, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (4, 1, '超C桃桃单杯周边套餐', '含限定桃桃鸭手机绳', 28.90, 34.00, 8.50, 'https://img.linlee.com/product/4.jpg', 500, 1, 3, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (5, 1, '超爽霸王杯（桃桃乌龙）', '1000ml 大块果肉', 19.00, 19.00, 10.00, 'https://img.linlee.com/product/5.jpg', 800, 1, 2, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (6, 1, '超C百香桃柠茶', '三重果香 层次分明', 19.00, 19.00, 10.00, 'https://img.linlee.com/product/6.jpg', 800, 1, 2, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (7, 1, '白葡萄冰柠茶', '当季巨峰 甜爽爆汁', 17.90, 17.90, 10.00, 'https://img.linlee.com/product/7.jpg', 800, 1, 2, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (8, 1, '西瓜冰柠茶', '无籽麒麟瓜 清爽一夏', 17.90, 17.90, 10.00, 'https://img.linlee.com/product/8.jpg', 800, 1, 2, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (9, 1, '椰椰冰柠茶', '生椰乳 + 柠檬 独特椰香', 19.90, 19.90, 10.00, 'https://img.linlee.com/product/9.jpg', 800, 1, 2, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (10, 1, '原叶鲜 · 甄奶茶', '鲜柠撞茶 冷热皆宜', 15.90, 15.90, 10.00, 'https://img.linlee.com/product/10.jpg', 800, 1, 1, '2025-11-22 17:34:06');
INSERT INTO `product` VALUES (11, 1, '测试', '测试', 1.00, 1.00, NULL, NULL, 1, 1, NULL, '2025-11-22 19:19:33');
INSERT INTO `product` VALUES (12, 1, '1', '1', 0.00, 0.00, NULL, '', 0, 1, 1, '2025-11-22 20:19:50');
INSERT INTO `product` VALUES (13, 1, '1', '1', 0.00, 0.00, NULL, '', 0, 1, 4, '2025-11-22 20:19:56');
...
-- Records of sku
-- ----------------------------
INSERT INTO `sku` VALUES (1, 1, 1, '[{\"杯型\": \"大杯\"}, {\"冰度\": \"正常冰\"}]', 16.90, 500, '2025-11-22 17:34:06');
INSERT INTO `sku` VALUES (2, 1, 1, '[{\"杯型\": \"大杯\"}, {\"冰度\": \"少冰\"}]', 16.90, 499, '2025-11-22 17:34:06');
INSERT INTO `sku` VALUES (3, 1, 2, '[{\"杯型\": \"大杯\"}, {\"冰度\": \"正常冰\"}]', 18.90, 500, '2025-11-22 17:34:06');
...
-- Records of staff
-- ----------------------------
INSERT INTO `staff` VALUES (1, 1, 'admin', '$2a$10$j0KkwAvu0V/on9oDJZLRuesj/wZlOYGYbpjz4WcSPauQpbVazN9V6', '林里', '创始人', '13272796154', 1, '2025-11-22 17:34:06');
INSERT INTO `staff` VALUES (2, 1, 'manager', '$2a$10$j0KkwAvu0V/on9oDJZLRuesj/wZlOYGYbpjz4WcSPauQpbVazN9V6', '王店长', '联合创始人', '13800138001', 1, '2025-11-22 17:34:06');
INSERT INTO `staff` VALUES (3, 2, 'staff2', '$2a$10$j0KkwAvu0V/on9oDJZLRuesj/wZlOYGYbpjz4WcSPauQpbVazN9V6', '葫芦', '老板', '13800138002', 1, '2025-11-22 17:34:06');
INSERT INTO `staff` VALUES (4, 2, 'test001', '$2a$10$RIkBtXqG4GILfQAIA.ZaVe5lZ8BBWzxRtxXjleZUDDUBXKzrZAHg6', '张三', '创始人', '13800138888', 1, '2025-11-22 21:45:23');
INSERT INTO `staff` VALUES (5, 3, 'Eighteen', '$2a$10$j0KkwAvu0V/on9oDJZLRuesj/wZlOYGYbpjz4WcSPauQpbVazN9V6', '封灵天', '创始人', '13272796155', 1, '2025-11-22 21:48:25');
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户地址表' ROW_FORMAT = Dynamic;
